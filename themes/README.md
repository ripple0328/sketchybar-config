...
┌─ BACKGROUND_PRIMARY ──────────────────────────────────────────────────┐
│                                                                       │
│  🍎(ICON_PRIMARY) [1](WORKSPACE_ACTIVE) [2][3](TEXT_SECONDARY)         │
│  📁 VS Code(TEXT_PRIMARY)  📊(ACCENT_PRIMARY) 85%(TEXT_PRIMARY)        │
│  🔔 0(STATE_WARNING)  🔋 100%(ICON_PRIMARY)  22:37(TEXT_PRIMARY)       │
└───────────────────────────────────────────────────────────────────────┘
```
